...
fls_demo.cpp is an example that performs the exact and approximate clustering algorithm on a finite linear source model. It requires the C library pari, which can be installed using
